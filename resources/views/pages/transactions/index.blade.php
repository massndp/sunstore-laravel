                            ...
                            <tbody>
                               ...
                               <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('transactions.edit', $item->id)}}" class="btn btn-success btn-sm">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <form action="{{route('transactions.destroy', $item->id)}}" method="POST" class="d-inline" onclick="return confirm('yakin produk ingin dihapus?') ">
                                    @csrf
                                    @method('delete')
