            ...
            <div class="card-body card-block">
                <form action="{{route('products.update', $item->id)}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="type" class="form-control @error('type') is-invalid @enderror" value="{{$item->type}}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" rows="10" class="form-control ckeditor @error('description') is-invalid @enderror ">{{$item->description}}</textarea>
